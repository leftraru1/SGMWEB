...
(function ($) {
    ...
    $.fn.lksSubMenu = function () {
        ...
        return this.each(function () {
            ...
            menu.find('ul li ul > a').bind('click', function (event) {
                ...
                if (currentlink.parent().find('li.active').size() == 1) {
                    //cerramos el link porque apretamos sobre el mismo abierto
                    currentlink.parent().find('li.active').slideUp('medium', function () {
                        // le quitamos la clase
                        currentlink.parent().find('li.active').removeClass('active');
                    });
                }
            ...
            function show(currentlink) {
                currentlink.parent().find('li').addClass('active');
                currentlink.parent().find('li').slideDown('medium');
            }
        });
    }
