...
public class Procedimientos
{
    ...
    public void Insertamos_log_proceso(String archivo, String desc,String duplicados, String errores, String cargados,String estado,String id_proceso,String rut_empresa,String grupo_proceso)
    {
        OracleConnection objConexion = new OracleConnection(conexion_cliente_oracle);
        objConexion.Open();
