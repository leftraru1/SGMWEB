<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POPcortadores.aspx.vb" Inherits="POPcortadores" %>
...
<head runat="server">
    <title>Asignaciones por Cortador Sistema CYR</title>
                                    ...
                                    &nbsp;<asp:Label ID="lb_mensaje_coincidencias" runat="server"
                                        Width="179px"></asp:Label><asp:DataGrid ID="GrillaLectores" OnDeleteCommand="cmSelecciona" runat="server"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="cod_lector" HeaderText="C&#243;digo Cortador">
                                                    <HeaderStyle Width="15%" />
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="nom_lector" FooterText="sfgdgf" HeaderText="Nombre Cortador">
