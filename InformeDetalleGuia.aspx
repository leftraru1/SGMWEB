<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InformeDetalleGuia.aspx.cs" Inherits="InformeDetalleGuia" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="800px" Width="800px" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportPath="ReporteDetalleGuia.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
