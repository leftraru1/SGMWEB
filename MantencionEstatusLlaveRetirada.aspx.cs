...
public partial class MantenedorEstatusLlaveRetirada : System.Web.UI.Page
{
    string id_perfil;
    ...
    internal void carga_estatusllr(string RutDeEmpresa, string PerfilDeUsuario, string ID_DE_Usuario) 
    {
        ...
        {
            OracleCommand cmdAcceso = new OracleCommand("PK_ESTATUS_LLAVER.CARGAR_ESTATUS_LLAVER", CnOra);
        ...
        foreach (DataRow drLlaverItem in dtLlaver.Rows) 
        {
            ...
            dr["rut_empresa"] = drLlaverItem["rut_empresa"].ToString();
        ...
        GrillaEstatusllaveRetirada.DataSource = MydataView;
        GrillaEstatusllaveRetirada.DataBind();
    ...
    {
        GrillaEstatusllaveRetirada.Visible = false;
        tablaEstatusLlaveRetirada.Visible = true;
    ...
    protected void btn_agregaEstatusLlR_Click(object sender, EventArgs e)
    {
        ...
        { //validaciones
            ...
            OracleDataAdapter ComandoDA = new OracleDataAdapter("PK_ESTATUS_LLAVER.INSERTA_LLAVER", objConexion);
            ...
            PRO.agrega_parametro_sp(ComandoDA, "i_cod_llr", OracleType.Int32, ParameterDirection.Input, txtCodigoLlave.Text);
            PRO.agrega_parametro_sp(ComandoDA, "i_descripcion", OracleType.NVarChar, ParameterDirection.Input, txtDescripcionLlave.Text);
            ...
            try
            {
                ...
                lbInformacion0.Text = " Estatus Llave Retirada ingresada correctamente!";
                lbAsci.Text = " ✔ ";
    ...
    protected void GrillaEstatusllaveRetirada_EditCommand(object source, DataGridCommandEventArgs e)
    {
        string indice;
        indice = e.Item.ItemIndex.ToString();
        Response.Redirect("ModificarEstatusLlaveRetirada.aspx?idLlaveR=" + (GrillaEstatusllaveRetirada.Items[Int32.Parse(indice)].Cells[0].Text));
        Response.End();
    }
    protected void GrillaEstatusllaveRetirada_SelectedIndexChanged(object sender, EventArgs e)
    {

    }
    protected void GrillaEstatusllaveRetirada_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
    {
        GrillaEstatusllaveRetirada.CurrentPageIndex = e.NewPageIndex;
        carga_estatusllr(lb_rut_empresa.Text, lb_perfil_usuario.Text, lb_id_usuario.Text);
    }
}
