<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InformeComercialConsulta.aspx.cs" Inherits="InformeComercialConsulta" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="1100px" Width="800px" ConsumeContainerWhitespace = "false" ExportContentDisposition="AlwaysAttachment" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
            <LocalReport ReportPath="ReportComercial.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSetComercial" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
