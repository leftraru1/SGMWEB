<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReporteTotalCYR.aspx.vb" Inherits="CYR_ReporteTotalCYR" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Reporte Total CyR</title>
                        ...
                        <tr id="Tr1" runat="server">
                            <td align="left" colspan="2" nowrap="nowrap">
                                <div id="titulo_mod" runat="server" class="WebPartTitle_ext">
                                    Reporte Total de Corte y Reposiciones</div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <table id="TABLE1" align="center" border="0" cellspacing="0" style="width: 855px">
                            ...
                            <tr style="color: #000000">
                                <td colspan="2" style="width: 162px">
                                            ...
                                            <tr>
                                                <td align="center" colspan="4" style="width: 100%">
                                                    <asp:Label ID="lb_titulopdf" runat="server" Font-Bold="True" Font-Names="Arial Unicode MS"
                                                        Font-Size="Small" Font-Underline="True" Text="Reporte Total CYR por Localidad"></asp:Label></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td>
                                    <asp:DataGrid
                                        ID="GrillaTotalCYR" runat="server" AutoGenerateColumns="False"
                                        BorderWidth="1px" CellPadding="1" CellSpacing="1" CssClass="GridAlternativeItems"
                                        GridLines="None" Height="1px" PageSize="200" Width="852px" Font-Size="XX-Small" AllowPaging="true">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="CONTRATISTA" HeaderText="Nom Contratista">
                                                <HeaderStyle Width="10%" />
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="ID_SERVICIO" HeaderText="Num Cliente"></asp:BoundColumn>
                                            ...
                                            <asp:BoundColumn DataField="NOMBRE_CLIENTE" HeaderText="Nom Cliente">
                                                <HeaderStyle Width="8%" />
                                            </asp:BoundColumn>
                                            ...
                                            <asp:BoundColumn DataField="CLAVE_EFECTIVA" HeaderText="Clave Efectiva">
                                                <HeaderStyle Width="12%" />
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="CLAVE_IMPROCEDENTE" HeaderText="Clave Improcedente"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="FECHA_GENERACION" HeaderText="Fecha Generaci&#243;n"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="FECHA_EJECUCION" HeaderText="Fecha Ejecuci&#243;n"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="COD_CORTADOR" HeaderText="Cod Cortador"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="NOMBRE_CORTADOR" HeaderText="Nombre Cortador"></asp:BoundColumn>
                                    ...
                                    <td>
                                    <asp:DataGrid
                                        ID="GrillaTotalCYR_Aux" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                        BorderWidth="1px" CellPadding="1" CellSpacing="1" CssClass="GridAlternativeItems"
                                        GridLines="Horizontal" Height="1px" PageSize="6" Width="852px" Font-Size="XX-Small" Visible="False">
                                        <FooterStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                        <EditItemStyle BackColor="Honeydew" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                            Font-Strikeout="False" Font-Underline="False" Wrap="False" />
