<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CargaManualCortesExcel.aspx.vb" Inherits="CargaManualCortesExcel" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Carga de Cortes - Sistema CYR</title>
                ...
                <td style="width: 732px">
                    <div class="WebPartShadow_ext">
                        <div class="WebPartTitle_ext">
                            Carga reposiciones Manuales.</div>
                        <table align="center" border="0" cellspacing="4" style="width: 709px; height: 66px"
                            ...
                            <tr>
                                <td colspan="2" style="height: 9px">
                                    <asp:Button ID="btnCargaRutero" runat="server" CssClass="botonnew" Text="Importar" Width="128px" Height="24px" />
                                    <asp:Button ID="Btncarga2" runat="server" Text="Prueba " CssClass="botonnew" Width="136px" Visible="False" Height="24px" />
                            ...
                            <tr>
                                <td align="right" colspan="2" style="height: 3px">
                                    &nbsp;<asp:Button ID="btnVolver" runat="server" CssClass="botonnew" Text="<< Volver Menu"
                                        Width="120px" /></td>
                            </tr>
                            <tr>
