<%@ Page Title="" Language="C#" MasterPageFile="~/menu.master" AutoEventWireup="true" CodeFile="RecepcionLecturas_new.aspx.cs" Inherits="RecepcionLecturas_new" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <table style="width:89%; height: 308px;">
            ...
            <tr>
                <td class="auto-style45">Contratista</td>
                <td class="auto-style46">
                             <asp:DropDownList ID="ddContratista" runat="server" Height="16px" Width="250px" CssClass="ComboBox2">
                    </asp:DropDownList>
                    <asp:TextBox ID="nomArch" runat="server" Width="252px" CssClass="TextBox4" Visible="False"></asp:TextBox>
                    &nbsp;
                    </td>
