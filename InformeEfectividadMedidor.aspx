           ...
           <table class="auto-style9">
            ...
            <tr>
                ...
                <td>
                 ...
                 <tr>
                <td class="auto-style8" >
                <asp:label ID="Label7" runat="server" text="Total Ordenes con 1er Repaso:" Font-Bold="True" Font-Size="Medium"></asp:label>             
                </td>
                <td>
                    <asp:TextBox ID="TextBox3" runat="server" CssClass="TextBox_totalizador" ReadOnly="True"></asp:TextBox>
                    <asp:TextBox ID="TextBox4" runat="server" CssClass="TextBox_totalizador" ReadOnly="True" Visible="true"></asp:TextBox>
                    %
                    ...
                    <tr>
                <td class="auto-style8"> 
                    <asp:label ID="Label6" runat="server" text="Total Ordenes con 2do Repaso:" Font-Bold="True" Font-Size="Medium"></asp:label>         
                </td>
                <td>
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="TextBox_totalizador" ReadOnly="True"></asp:TextBox>
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="TextBox_totalizador" ReadOnly="True" Visible="true">
                    </asp:TextBox>
                    %
                    </td>
            </tr>
                <tr>
                <td class="auto-style8" >
                <asp:label ID="Label8" runat="server" text="Total Ordenes con Repaso:" Font-Bold="True" Font-Size="Medium"></asp:label>             
                </td>
                <td>
                    <asp:TextBox ID="TextBox5" runat="server" CssClass="TextBox_totalizador" ReadOnly="True" BackColor="#33ccff"></asp:TextBox>
                    <asp:TextBox ID="TextBox6" runat="server" CssClass="TextBox_totalizador" ReadOnly="True" Visible="true"></asp:TextBox>
                    %
                   ...
                   <%-- <tr>
                <td class="auto-style8"> 
                    <asp:label ID="Label9" runat="server" text="Total Ordenes con Repaso:" Font-Bold="True" Font-Size="Medium"></asp:label>         
                </td>
                <td>
                    <asp:TextBox ID="TextBox7" runat="server" CssClass="TextBox_totalizador" ReadOnly="True"></asp:TextBox>
                    <asp:TextBox ID="TextBox8" runat="server" CssClass="TextBox_totalizador" ReadOnly="True" Visible="false">
                    </asp:TextBox>
                    %
                    </td>
            </tr>--%>
