        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
          ...
          <%--      <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" CssClass="TextBox_totalizador" ReadOnly="True"></asp:TextBox>
                    %</td>
            </tr>--%>
              <%--      <tr>
                <td class="auto-style8"> 
                ...
                <td>
                    ...
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="TextBox_totalizador" ReadOnly="True">
                    </asp:TextBox>
                    %
                    </td>
            </tr>--%>
