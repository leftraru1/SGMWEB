                ...
                <td>
                    <div class="WebPartShadow_ext">
                        <div class="WebPartTitle">
                            Cierre Proceso Parcial Reposición</div>
        ...
        <table id="tbl_inicio2" runat="server" align="center" border="0" cellspacing="0"
            ...
            <tr>
                <td align="left" colspan="2">
                    <div>
                        <asp:Label ID="lbl_dias" runat="server" Text="Días que deben transcurrir desde fecha de generación para Cierre de Reposiciones Improcedentes" CssClass="Label"></asp:Label>
                    ...
                    <asp:LinkButton ID="lk_ir_ManOT" runat="server" Font-Names="Arial Unicode MS" Font-Size="X-Small"
                        ForeColor="Blue">Aquí</asp:LinkButton></td>
            </tr>
            <tr>
                <td align="left" colspan="2">
                </td>
            ...
            <tr>
                <td colspan="2" style="text-align: right; height: 21px;">
                    ...
                    <asp:Button ID="btnCancelar" runat="server" CssClass="botonnew" Text="Abrir Proceso Parcial (Administrador)" ToolTip="Habilita órdenes para digitación según filtro de fechas seleccionado. Sólo usuaria administradores!" Width="229px" />
