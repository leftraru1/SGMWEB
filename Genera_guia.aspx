...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table id="1" style="height: 20px; width: 445px; padding-bottom:10px;">
        ...
        <tr>
            ...
            <td class="" >
                <asp:TextBox ID="numero_guia" runat="server" Width="200px" CssClass="TextBox" MaxLength="18"  ></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="" >
                <asp:TextBox ID="reserva" runat="server" Width="200px" AutoPostBack="true" CssClass="TextBox" MaxLength="30"></asp:TextBox>
            </td>
        </tr>
        ...
        <label style="position:absolute;top:539px; left:1086px; width:159px;">FOTO GUÍA DESPACHO (.jpg|.jpeg|.png|.pdf)</label>
        ...
        <tr>
            ...
            <td class="" >
                <asp:TextBox ID="rut_despacho" runat="server" Width="100px" CssClass="TextBox" MaxLength="13" ToolTip="Ej: 12345678-K" ></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="" >
                <asp:TextBox ID="rut_entidad" runat="server" Width="100px" CssClass="TextBox" MaxLength="13" ToolTip="Ej: 12345678-K" ></asp:TextBox>
            </td>
        </tr>
        </table>
        </fieldset>
        ...
        <tr>
            ...
            <td class="">
                <asp:TextBox ID="rut_retiro" runat="server" Width="100px" CssClass="TextBox" MaxLength="13" ToolTip="Ej: 12345678-K" ></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td class="auto-style70">
                <asp:Label ID="Label18" runat="server" Text="Contratista destino :"></asp:Label>
            </td>
            <td class="auto-style78">
...
<%--            <td class="auto-style92">
            ...
            <td class="auto-style93">
                ...
                <asp:TextBox ID="cantidad" runat="server" Width="100px" CssClass="TextBox" MaxLength="4" ></asp:TextBox>
            ...
            <div style="padding-top:10px;padding-bottom:10px;text-align:center;">
                ...
                <asp:Label ID="carga" runat="server" Text="Carga detalle (.CSV): "></asp:Label>
                <asp:FileUpload ID="fuArchivo" runat="server" BorderStyle="None" Width="280px" CssClass="Button" ToolTip="Formato .CSV sin cabeceras - Campos: Cod. material, Descripción, Diametro, Cantidad" />
...
<%--                <asp:Button ID="guardar_detale" Text="Guardar detalle" runat="server" Width="114px" CssClass="botonnew" Height="16px" ></asp:Button>--%>
        ...
        <div style="padding-top:10px;padding-bottom:10px;text-align:center;">
                ...
                <asp:Button ID="Button3" Text="Finalizar" OnClick="finalizar" OnClientClick="return confirm('¿Seguro que desea cerrar la guía?');" runat="server" Width="114px" CssClass="botonnew" Height="16px" ></asp:Button>
        </div>
        </fieldset>
    </div>
</asp:Content>
