    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <table id="Table2" runat="server" style="width: 126%; height: 122px;">
                <tr>
                    <td>
                        <img src="Imagenes/ok.bmp" runat="server" id="IMG2" /><img src="/ESSBIO_MED/Imagenes/cross2.bmp" runat="server" id="IMG5" /><img src="/ESSBIO_MED/Imagenes/warning.bmp" runat="server"  id="IMG6" />&nbsp;
