<%@ Page Title="" Language="C#" MasterPageFile="~/menu.master" AutoEventWireup="true" CodeFile="MantencionEstatusOrden.aspx.cs" Inherits="MantencionEstatusOrden" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <script type="text/javascript">
           $(function () {
               $("[id*=GrillaEstatusOrden] td").hover(function () {
    ...
    <script>
      ...
      <table ID="tablaBody" style="WIDTH: 758px; HEIGHT: 152px; background-color: #FFFFFF;" cellSpacing="0" cellPadding="0" width="758"
          ...
          <tr>
              ...
              <td></td>  </tr>
           <tr >
            <td align="center" colspan="4" style="font-size: medium; font-weight: bold; font-family: Arial, Helvetica, sans-serif; text-decoration: underline; color: #000000;" class="auto-style5"  >Mantenedor de Estatus Orden</td>
        </tr>
 <tr>    
          ...
          <tr>    
            <td align="center">    &nbsp;</td><td align="right">
                                                        <asp:Button ID="btnok_agregar0" runat="server" CausesValidation="False" CssClass="botonnew" Text="Nuevo Estatus Orden" Width="20%" Height="22px" OnClick="btnok_agregar0_Click" />
         ...
         <tr><td></td>
                             ...
                             <td align="right" colspan="1">&nbsp;&nbsp;<asp:DataGrid ID="GrillaEstatusOrden" runat="server" AutoGenerateColumns="False" BorderWidth="1px" CellPadding="1" CellSpacing="1" CssClass="GridActiveItem" Height="1px" Width="699px" BorderStyle="Ridge" Font-Bold="True" AllowPaging="True" PageSize="20" OnPageIndexChanged="GrillaEstatusOrden_PageIndexChanged" OnSelectedIndexChanged="GrillaEstatusOrden_SelectedIndexChanged" >
                                 ...
                                 <Columns>
                                     <asp:BoundColumn DataField="id_estatus_orden" HeaderText="id_estatus_orden" Visible="False">
                                         <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                                <HeaderStyle Font-Bold="True" Width="20%" ForeColor="White"/>
                                     </asp:BoundColumn>
                                     <asp:BoundColumn DataField="cod_estatus_orden" HeaderText="CODIGO ESTATUS ORDEN">
                                         <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" />
                                <HeaderStyle Font-Bold="True" Width="20%" ForeColor="White"/>
                                     </asp:BoundColumn>
     ...
     <table runat="server" id="tablaEstatusOrden" style="border: 1px solid #808080; font-family: Arial; font-size: medium; font-weight: bold; width: 947px; background-color: #CCCCCC;" align="center" >
     <tr>
     ...
     <tr >
            <td  colspan="1" style="font-size: medium; font-weight: bold; font-family: Arial, Helvetica, sans-serif; text-decoration: underline; color: #000000; width: 273px;" class="auto-style20"  >&nbsp;Agregar Estatus Orden</td>
    ...
    <tr>
        ...
        <td style="width: 241px">
            <asp:TextBox ID="txtDescripcionEstatusOrden" runat="server" Width="94%" MaxLength="50" required></asp:TextBox>
        ...
        <tr>
            ...
            <asp:TextBox ID="txtCodigoEstatusOrden" runat="server" Width="94%" MaxLength="50" required></asp:TextBox>
           </td>
...
<td class="auto-style23" style="width: 273px">
        ...
        <td align="center" class="auto-style14" style="width: 207px">
            <STRONG>
                                                    <asp:Button ID="btn_agregaEstatusOrden" runat="server" CssClass="botonnew" Text="Agregar Estatus Orden" Width="95%" Height="23px" />
                                                </strong></td>
        <td align="right" class="auto-style14">
            <STRONG>
                                                    <asp:Button ID="btoVolver" runat="server" CssClass="botonnew" Text="Volver" Width="95%" Height="23px" formnovalidate  />
                                                </strong>&nbsp;
