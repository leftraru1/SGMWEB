<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TransferenciaSGLaSGC.aspx.vb" Inherits="TransferenciaSGLaSGC" %>
...
<body>
    <form id="form1" runat="server">
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 758px;
            height: 118px" width="758" id="TABLE1">
            <tr>
                        ...
                        <table align="center" border="0" cellspacing="0" style="width: 709px; height: 1px"
                            ...
                            <tr>
                                ...
                                <td align="left" nowrap="nowrap" style="width: 418px; height: 4px">
                                    <select id="myCbo" runat="server" name="myCbo" style="width: 165px" class="comboBox">
            ...
            <tr style="color: #000000">
                <td align="center" colspan="2" style="width: 760px; height: 3px; text-align: left">
                                        ...
                                        <asp:DataGrid ID="GrillaTransferencia" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    &nbsp;
                            ...
                            <tr>
                                <td align="left" colspan="2">
                                        <h2>Total Grupo Lote: .-</h2></td>
                            </tr>
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Button ID="Button1" runat="server" CssClass="Button" Text="Transferir Lecturas"
                                        Width="120px" />
