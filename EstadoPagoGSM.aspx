            ...
            <table id="tablaAsig" style="width: 126%; height: 122px;">
                ...
                <tr>
                    ...
                    <td class="auto-style89">
                       <asp:DropDownList ID="cb_contratista" runat="server" CssClass="ComboBox" OnSelectedIndexChanged="cb_contratista_SelectedIndexChanged" Width="200px">
                       </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td class="auto-style89" style="height: 23px">
                    ...
                    <td class="auto-style69" style="height: 23px"></td>
                </tr>
                <tr>
                    <td style="width:50px"> 
                        ...
                        <asp:Panel ID="panGrid" runat="server" Height="326px" HorizontalAlign="Center" ScrollBars="Auto" Width="1250px">            
                                    <asp:GridView ID="gridEstadoPago" runat="server" AllowPaging="false" AutoGenerateColumns="false" CellPadding="1"  EnableModelValidation="false"  Height="100px"   CssClass="GridAlternativeItems"    ForeColor="#333333"  PageSize="10" Width="1319px">
                                       ...
                                       <Columns>
                                         ...
                                         <asp:BoundField HeaderText="FECHA INTEGRACION" DataField="FECHA_INTEGRACION"/>                                     
                                         ...
                                         <asp:BoundField HeaderText="SERIE MEDIDOR"	    DataField="SERIE_MEDIDOR" DataFormatString="{0} ."/>	
