<%@ Page Language="VB"  CodeFile="MantencionIndicadorespop.aspx.vb" Inherits="graphpop" %>
            ...
            <table id="TABLE2" align="center" border="0" cellpadding="0" cellspacing="0" style="width: 858px;
                ...
                <tr style="font-weight: bold">
                    <td style="width: 855px">
                     ...
                     <input type=button value=Atr&aacute;s onclick="history.go(-1)" id="Button2" style="width: 112px" class="Button">
