...
public partial class VisorHistoricos : System.Web.UI.Page
{
    ...
    protected void gridOrden_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "ver_fotos")
            {
                ...
                if (foto) //posee fotos.
                {
                    String vtn = "window.open('popVisorFotos.aspx?servicio=" + servicio + "&id=" + proceso + "&operador=" + cod_op + "&grupo=" + grupo + "&visita=" + visita + "','Dates','scrollbars=yes,resizable=yes,height=675,width=1270')";
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", vtn, true);  
                }                
                else
                {
