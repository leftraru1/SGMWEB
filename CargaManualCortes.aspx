<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CargaManualCortes.aspx.vb" Inherits="CargaManualCortes" %>
                ...
                <td style="width: 732px">
                    <div class="WebPartShadow_ext">
                        <div class="WebPartTitle_ext">
                            Importar Archivos de Integración de Cortes formato excel(xls)</div>
                        <table border="0" cellspacing="4" style="width: 709px; height: 66px"
                            width="709">
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" style="height: 9px">
                                    <asp:Button ID="btnCargaRutero" runat="server" CssClass="botonnew" Text="Importar" Width="128px" />
                                    <asp:Button ID="Btncarga2" runat="server" Text="Prueba " CssClass="botonnew" Width="136px" Visible="False" />
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 695px; height: 15px">
                                        <tr>
                                            <td align="center" colspan="3" style="height: 19px; text-align: left">
                                                <a href="Descargas/ESTRUCTURA_CARGA_MANUAL_CORTES .xls" style="color: #0000ff; background-color: #f5f5f5"
                                                    target="_blank">Descargar -Estructura Cortes</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                    ...
                    &nbsp;
                    <img alt=""  id="img_ok" runat="server" src="fotos/ok.bmp" /><asp:Label ID="lb_mensaje" runat="server"
                                        Font-Bold="False" Font-Names="Arial Unicode MS" ForeColor="#0000C0" Width="377px" Font-Size="Small"></asp:Label>
                    <asp:Label ID="lb_mensaje_error" runat="server" Font-Bold="True" Font-Names="Arial"
                        Font-Size="X-Small" ForeColor="Red" Width="141px"></asp:Label>
                    ...
                    <asp:DataGrid ID="GrillaGeneral" runat="server" AutoGenerateColumns="False" BorderColor="#003366"
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="NOMBRE_ARCHIVO" HeaderText="NOMBRE_ARCHIVO">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="True" Width="25%" BackColor="CornflowerBlue" ForeColor="White" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="REGISTROS" HeaderText="REGISTROS">
                                <HeaderStyle Width="25%" BackColor="CornflowerBlue" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="White" />
                            </asp:BoundColumn>
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="NOMBRE_ARCHIVO" HeaderText="NOMBRE_ARCHIVO">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="True" Width="14%" BackColor="CornflowerBlue" ForeColor="White" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="DESCRIPCION" HeaderText="DESCRIPCION">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="True" Width="14%" BackColor="CornflowerBlue" ForeColor="White" />
